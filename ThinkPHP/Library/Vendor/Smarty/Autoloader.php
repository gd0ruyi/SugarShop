...
class Smarty_Autoloader
{
    ...
    public static function register($prepend = false)
    {
        ...
        if (version_compare(phpversion(), '5.3.0', '>=')) {        	
            spl_autoload_register(array(__CLASS__, 'smarty_autoload'), true, $prepend);
        } else {
            spl_autoload_register(array(__CLASS__, 'smarty_autoload'));
        }
    }
     ...
     */
    public static function smarty_autoload($class)
    {
